...
public class Orange extends Fruits implements calcPrice {	// Orange as a sub class extends of Fruits
	
	private String colour, taste;
	private double price, weight, discount;
	private int quantity;
	
	public Orange(String name, String colour, String taste, double price,double weight, int quantity) {
		super(name);
		this.colour = colour;
		this.taste = taste;
		this.price = price;
